...
const extraMetadata = {
  external_url: "https://metameerkat.club", // Replace with your website or remove this line if you do not have one.
};
...
const CONTRACT_NAME = 'Meta Meerkat Club Test';
const CONTRACT_SYMBOL = 'MMCT';
const METADATA_UPDATABLE = true; // set to false if you don't want to allow metadata updates after minting
const OWNER_ADDRESS = '0x4d858B0a6D5C2Fcf0DdbE8b66485d48aC48568a7';
const TREASURY_ADDRESS = '0x4d858B0a6D5C2Fcf0DdbE8b66485d48aC48568a7';
const MAX_SUPPLY = 4503; // The maximum number of NFTs that can be minted. CANNOT BE UPDATED!
...
const GENERIC_DESCRIPTION = "Meta Meerkat Club Test Reveal"; // Replace with what you want the generic descriptions to say.
const GENERIC_IMAGE = "https://ipfs.io/ipfs/bafkreig3bxcuh7fky5vohreta6v2aawkphep2aufnm2e6zhz7jhw2vp3gm"; // Replace with your generic image that will display for all NFTs pre-reveal.
